...
infolder = 'F:\Nisha\Nisha\2024\Rooks projcts\projeect3((pest identification)\pestdetectioncode\coconutdata\test';    
...
for i = 1:n
    figure;
    subplot(1,3,1)
    m=imread(['F:\Nisha\Nisha\2024\Rooks projcts\projeect3((pest identification)\pestdetectioncode\coconutdata\test\im' num2str(i) '.jpg']);
    imshow(m);
    title('Input Image');
...
[precision,specificity,Acc,f1score]= AnnCOCO(Inpc,Target);
